...
function initModels(sequelize) {
  ...
  CatalogProductEntity.belongsToMany(CatalogProductEntityMediaGallery, {through: CatalogProductEntityMediaGalleryValueToEntity, foreignKey: "entity_id", otherKey: "value_id" });
