...
module.exports = function(sequelize, DataTypes) {
  return sequelize.define('SalesOrderAggregatedCreated', {
    id: {
      autoIncrement: true,
    ...
    sequelize,
    tableName: 'sales_order_aggregated_created',
    timestamps: false,
    indexes: [
      {
        name: "PRIMARY",
      ...
      {
        name: "SALES_ORDER_AGGREGATED_CREATED_PERIOD_STORE_ID_ORDER_STATUS",
        unique: true,
        using: "BTREE",
        fields: [
          { name: "period" },
      ...
      {
        name: "SALES_ORDER_AGGREGATED_CREATED_STORE_ID",
        using: "BTREE",
        fields: [
          { name: "store_id" },
        ]
